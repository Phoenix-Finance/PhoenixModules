...
contract acceleratedMinePoolData is versionUpdater,Halt,proxyOperator,safeTransfer,ReentrancyGuard {
    ...
    mapping(address=>uint256) public userNFTDeposit;
    ...
    event BoostingDeposit(address indexed account,uint256 indexed tokenId);
    event BoostingWithdraw(address indexed account,uint256 indexed tokenId);
}
